...
printf("\n\nCreating Linda's profile and setting her scores to 9.5, 9, 7.8 and 8.9\n");
printf("Printing her stats: \n");
changename(toa, "Linda");
changescores(toa,9.5,9,7.8,8.9);
...
printf("Printing her stats: \n");
printstats(toa);
printf("\n\nSetting just her beam score to 7.1\n");
changescore(toa,"beam",7.1);
printf("Printing her stats: \n");
printstats(toa);
